...
public class GymTrainee {
    ...
    public GymTraineeId getId() { return id; }
    public void setId(GymTraineeId id) { this.id = id; }
    ...
    public MembershipState getMembershipStatus() { return membershipStatus; }
    public void setMembershipStatus(MembershipState membershipStatus) { this.membershipStatus = membershipStatus; }

    public BigDecimal getMembershipPrice() { return membershipPrice; }
    public void setMembershipPrice(BigDecimal membershipPrice) { this.membershipPrice = membershipPrice; }
